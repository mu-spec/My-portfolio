...
export function Logo() {
  return (
    <Link
      href="/"
      className="group inline-flex items-baseline gap-2 rounded-xs focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--color-focus)]"
